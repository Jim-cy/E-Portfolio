...
```{r leaflet_study_area, echo=FALSE}
library(dplyr)
library(leaflet)
library(sf)

# Read shapefiles (fixed parentheses)
plot1 <- st_read("C:/Users/cjin14.stu/OneDrive - UBC/MGEM/Term2/GEM599(2/E-portfolio/plot1.shp")
plot2 <- st_read("C:/Users/cjin14.stu/OneDrive - UBC/MGEM/Term2/GEM599(2/E-portfolio/plot2.shp")
plot3 <- st_read("C:/Users/cjin14.stu/OneDrive - UBC/MGEM/Term2/GEM599(2/E-portfolio/plot3.shp")
buffer <- st_read("C:/Users/cjin14.stu/OneDrive - UBC/MGEM/Term2/GEM599(2/E-portfolio/buffer.shp")
