...
The best performance of our predictive model is shown below. The relationship between tree height and diameter at breast height (DBH) is captured by the following equation:

\$\$\
\\text{DBH} = 8.931 + 0.623 \\times \\text{Height}\
\$\$
